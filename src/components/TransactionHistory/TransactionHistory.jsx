            ...
            <tbody>
                {items.map(({id, type, amount, currency}, index) => (
                    <TransactionRow key={id}>
                        <TransastionData color={getColorForEvenRows(index)}>{type}</TransastionData>
                        <TransastionData color={getColorForEvenRows(index)}>{amount}</TransastionData>
                        <TransastionData last color={getColorForEvenRows(index)}>{currency}</TransastionData>
                    </TransactionRow>
                ))}
            </tbody>
        </TransactionsTable>
